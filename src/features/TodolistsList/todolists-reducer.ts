...
export const removeTodolistTC = createAsyncThunk('todolist/removeTodolists', async (todolistId: string, {
    dispatch,
    rejectWithValue
}) => {
...
export const addTodolistTC = createAsyncThunk('todolist/addTodolists', async (title: string, {
    dispatch,
    rejectWithValue
}) => {
    dispatch(setAppStatusAC({status: 'loading'}))
